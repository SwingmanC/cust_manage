INSERT INTO sys_org (id, org_code, org_name, org_type, org_path, status, created_time, updated_time)
VALUES (10, 'BU_TRAFFIC', '交通能源BU', 'BU', '/10/', 'ENABLED', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);

INSERT INTO sys_user (id, user_name, oa_account, org_id, account_status, created_time, updated_time)
...
INSERT INTO biz_service (id, service_code, service_name, service_category, status, sort_no, created_time, updated_time)
VALUES
...
INSERT INTO biz_group_revenue_monthly (id, group_id, service_id, revenue_month, revenue_amount, source_system, sync_batch_no, sync_time, created_time, updated_time)
VALUES
...
INSERT INTO biz_group_bc (id, group_id, service_id, stat_month, quantity, source_system, created_time, updated_time)
VALUES
...
INSERT INTO biz_group_competitor (id, group_id, service_id, competitor_name, stat_month, quantity, remark, created_by, created_time, updated_by, updated_time)
VALUES
...
INSERT INTO crm_group_contact (id, group_id, contact_name, contact_phone, position_name, department_name, status, source_type, created_by, created_time, updated_by, updated_time, deleted_flag)
VALUES
...
INSERT INTO biz_opportunity (id, group_id, source_type, opportunity_name, opportunity_type, opportunity_status, service_id, expected_amount, expected_close_date, description, owner_user_id, created_time, updated_time)
VALUES
